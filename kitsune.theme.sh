...
function _omb_theme_PROMPT_COMMAND() {
  ...
  *)
  ...
  PS1=$TITLEBAR"\n${_omb_prompt_teal}┌─${_omb_prompt_bold_white}[\u@\h]${_omb_prompt_teal}─${_omb_prompt_bold_olive}(\w)$(scm_prompt_info)$python_venv\n${_omb_prompt_teal}└─${_omb_prompt_bold_red}[\A]$SC$BC${_omb_prompt_teal}-${_omb_prompt_bold_teal}[${_omb_prompt_red}${_omb_prompt_bold_red}\$${_omb_prompt_bold_teal}]${_omb_prompt_red} "
}
